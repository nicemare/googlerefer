...
$merah = "\e[91m";
echo "$hijau  _   _ _\n";
echo "$hijau | \ | (_) ___ ___ _ __ ___   __ _ _ __ ___ \n";
echo "$hijau |  \| | |/ __/ _ \ '_ ` _ \ / _` | '__/ _ \ \n";
echo "$hijau | |\  | | (_|  __/ | | | | | (_| | | |  __/ \n";
echo "$hijau |_| \_|_|\___\___|_| |_| |_|\__,_|_|  \___| \n";
echo "  $merah        Allif Maula Hafsah \n";
echo " \n \n";
echo ' Website Mu: ';
